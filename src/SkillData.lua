...
function TravelDictionary:CreateDictionaries()
    ...
    self.hunter:AddLabelTag({EN="Guide", DE="Führer", FR="Guide", ES="Guiar", RU="Путь"})
    self.hunter:AddSkill({
        id="0x7000A2C1",
        EN={name="Return to Camp"},
        DE={name="Zurück zum Lager"},
        FR={name="Retour au campement"},
        ES={name="Volver al campamento"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Cavada Grande", label="Michel Delving", zone="Shire"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a la Mansión de Thorin", label="Thorin's Hall", zone="Ered Luin"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Bree", label="Bree", zlabel="West Gate", zone="Bree"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Clegur", label="Clegur", zone="Swanfleet"},
        ...
        acquire={
            {cost={{amount=100, token=LC.token.DELVING_WRIT}},
                ...
                ES={vendor="Intendente de excavaciones"},
            ...
            {cost={{amount=25, token=LC.token.GREYFLOOD_MARK}},
                ...
                ES={vendor="Miniaventuras de las profundidades"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a la Ciénaga de los Cisnes", label="Swanfleet", detail="Lhan Garan", zone="Swanfleet"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.IRON_COIN_OF_CARDOLAN}},
                ...
                ES={vendor="Intendente (Dúnedain de Cardolan)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Cardolan", label="Cardolan", detail="Herne", zone="Cardolan"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Andrath", label="Andrath", zone="Cardolan"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Nobotella", label="Nobottle", zone="Yondershire"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.COPPER_BOUNDERS_COIN}},
                ...
                ES={vendor="Intendente (Vigilante de la lejanía)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Ost Guruth", label="Ost Guruth", zone="Lone-lands"},
        ...
        acquire={
            {
                ...
                ES={quest="Cazador: Naturaleza salvaje junto a Ost Guruth."},
            ...
            {cost={{amount=30, token=LC.token.MITHRIL_COIN}},
                ...
                ES={vendor="Entrenador de cazadores"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Esteldín", label="Esteldín", zone="North Downs"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Evendim", label="Evendim", detail="Tinnudir", zone="Evendim"},
        ...
        acquire={
            {
                ...
                ES={quest="Cazador: Senderos de Evendim"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Tornhad", label="Tornhad", zone="Angle of Mitheithel"},
        ...
        acquire={
            {cost={{amount=15, token=LC.token.MARK_OF_ANGLE}},
                ...
                ES={vendor="Intendente (Defensores del Ángulo)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Rivendel", label="Rivendell", zone="Trollshaws"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a las Montañas Nubladas", label="Misty Mountains", detail="Hrimbarg", zone="Misty Mountains"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Puente de Caballetes", label="Trestlebridge", zone="North Downs"},
        ...
        acquire={
            {cost={{amount=25, token=LC.token.MARK_OF_WILDS}},
                ...
                ES={vendor="Intendente (Hermandad de Leñadores)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Embarcadero de los Comerciantes", label="Trader's Wharf", zone="Evendim"},
        ...
        acquire={
            {cost={{amount=25, token=LC.token.MARK_OF_WILDS}},
                ...
                ES={vendor="Intendente (La Liga del Hacha)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Sûri-kylä", label="Sûri-kylä", zone="Forochel"},
        ...
        acquire={
            {cost={{amount=137, token=LC.token.SILVER}, {amount=60, token=LC.token.COPPER}},
                ...
                ES={vendor="Rûsu (Vendedora de recompensas de los Lossoth)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Angmar Occidental", label="West Angmar", detail="Aughaire", zone="Angmar"},
        ...
        acquire={
            {
                ...
                ES={quest="Cazador: Desolación junto a Aughaire"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Angmar Oriental", label="East Angmar", detail="Gath Forthnír", zone="Angmar"},
        ...
        acquire={
            {
                ...
                ES={quest="Cazador: Páramos cerca de Gath Forthnír"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Echad Dúnann", label="Echad Dúnann", zone="Eregion"},
        ...
        acquire={
            {
                ...
                ES={quest="Cazador: Conocimiento del terreno"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a la Sala Vigesimoprimera", label="Twenty-first Hall", zone="Moria"},
        ...
        acquire={
            {cost={{amount=153, token=LC.token.SILVER}, {amount=60, token=LC.token.COPPER}},
                ...
                ES={vendor="Mineros de la Guarnición de Hierro"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a Caras Galadhon", label="Caras Galadhon", zone="Lothlórien"},
        ...
        acquire={
            {cost={{amount=20, token=LC.token.LOTHLORIEN_SILVER_BRANCH}},
                ...
                ES={vendor="Malenfileg (Entrenador de cazadores)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a los Lindes del Bosque Negro", label="Mirk-eaves", zone="Mirkwood"},
        ...
        acquire={
            {cost={{amount=1, token=LC.token.MALLEDHRIM_BRONZE_FEATHER}},
                ...
                ES={vendor="Estellien (Vendedora de recompensas de los Malledhrim)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Harndirion", label="Harndirion", zone="Enedwaith"},
        ...
        acquire={
            {cost={{amount=5, token=LC.token.SILVER_TOKEN_OF_WILDS}},
                ...
                ES={vendor="Legrindavor (Vendedor de recompensas de la Compañía gris)"},
            ...
            {cost={{amount=5, token=LC.token.SILVER_TOKEN_OF_WILDS}},
                ...
                ES={vendor="Cannuion (Vendedor de recompensas de la Compañía gris)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Galtrev", label="Galtrev", zone="Dunland"},
        ...
        acquire={
            {cost={{amount=176, token=LC.token.SILVER}},
                ...
                ES={vendor="Intendente Dunlendino"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Stangard", label="Stangard", zone="Great River"},
        ...
        acquire={
            {cost={{amount=5, token=LC.token.SILVER_TOKEN_OF_ANDUIN}},
                ...
                ES={vendor="Ordlaf (Vendedor de recompensas de Stangard)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a Río Nevado", label="Snowbourn", zone="East Rohan"},
        ...
        acquire={
            {cost={{amount=50, token=LC.token.SILVER_TOKEN_OF_RIDDERMARK}},
                ...
                ES={vendor="Intendente de objetos diversos de Estemnet"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a Forlaw", label="Forlaw", zone="Wildermore"},
        ...
        acquire={
            {cost={{amount=50, token=LC.token.WILDERMORE_COIN}},
                ...
                ES={vendor="Ethelmund (Gente de las Tierras Feroces)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a Aldburg", label="Aldburg", zone="West Rohan"},
        ...
        acquire={
            {cost={{amount=100, token=LC.token.WESTEMNET_IRON_COIN}},
                ...
                ES={vendor="Intendente (Eorlingas)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía al Abismo de Helm", label="Helm's Deep", zone="West Rohan"},
        ...
        acquire={
            {cost={{amount=125, token=LC.token.WESTEMNET_IRON_COIN}},
                ...
                ES={vendor="Intendente (Helmingas)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a Dol Amroth", label="Dol Amroth", zone="Western Gondor"},
        ...
        acquire={
            {cost={{amount=25, token=LC.token.AMROTH_SILVER_PIECE}},
                ...
                ES={vendor="Intendente (Dol Amroth)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a Arnach", label="Arnach", zone="Eastern Gondor"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.EAST_GONDOR_SILVER_PIECE}},
                ...
                ES={vendor="Intendente (Montaraces de Ithilien)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a Minas Tirith", label="Minas Tirith", zone="Old Anórien"},
        ...
        acquire={
            {cost={{amount=30, token=LC.token.MINAS_TIRITH_SILVER_PIECE}},
                ...
                ES={vendor="Intendente (Defensores de Minas Tirith)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía al campamento de guerra", label="War-stead", zone="Far Anórien"},
        ...
        acquire={
            {cost={{amount=5, token=LC.token.EXQUISITE_WOOD_CARVING}},
                ...
                ES={vendor="Intendente (Jinetes de Rohan)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a Minas Tirith después de la batalla", label="Minas Tirith after battle", zone="Anórien"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=20, token=LC.token.HOST_OF_WEST_SILVER_PIECE}},
                ...
                ES={vendor="Intendente (Hueste del Oeste)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía al Campamento de la Hueste", label="Camp of the Host", zone="The Wastes"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a Haerondir", label="Haerondir", zone="The Wastes"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a la base de Udûn", label="Udûn Foothold", zone="Mordor"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.SILVER_SIGNET_OF_THANDRIM}},
                ...
                ES={vendor="Intendente (Recompensas de Conquista de Gorgoroth)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía a Valle", label="Dale", zone="Eryn Lasgalen"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.TOKEN_OF_LAKE_AND_RIVERS}},
                ...
                ES={vendor="Intendente (Recompensas de los hombres de Valle)"},
            ...
            {cost={{amount=10, token=LC.token.TOKEN_OF_LAKE_AND_RIVERS}},
                ...
                ES={vendor="Intendente (Recompensas de los elfos de Felegoth)"},
            ...
            {cost={{amount=10, token=LC.token.TOKEN_OF_LAKE_AND_RIVERS}},
                ...
                ES={vendor="Intendente (Recompensas de los enanos de Erebor)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Járnfast", label="Járnfast", zone="The Ironfold"},
        ...
        acquire={
            {cost={{amount=5, token=LC.token.MARK_OF_LONGBEARDS}},
                ...
                ES={vendor="Intendente (Recompensas de las Moradas de los Enanos)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Skarháld", label="Skarháld", zone="Ered Mithrin"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Beorninghús", label="Beorninghús", zone="Vales of Anduin"},
        ...
        acquire={
            {cost={{amount=20, token=LC.token.VALES_BEORNING_TOKEN}},
                ...
                ES={vendor="Protectora de los Valles"},
            ...
            {cost={{amount=20, token=LC.token.VALES_BEORNING_TOKEN}},
                ...
                ES={vendor="Intendente (Recompensas del Pueblo salvaje)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Hultvís", label="Hultvís", zone="Vales of Anduin"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Estolad Lân", label="Estolad Lân", zone="Imlad Morgul"},
        ...
        acquire={
            {cost={{amount=20, token=LC.token.SIGIL_OF_IMLAD_ITHIL}},
                ...
                ES={vendor="Intendente (La Compañía Blanca)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Limlók", label="Limlók", zone="Wells of Langflood"},
        ...
        acquire={
            {cost={{amount=20, token=LC.token.NORTHERN_GULMARK}},
                ...
                ES={vendor="Intendente (Protectores de las Tierras Ásperas)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Annâk-khurfu", label="Annâk-khurfu", zone="Elderslade"},
        ...
        acquire={
            {cost={{amount=25, token=LC.token.COPPER_COIN_OF_GUNDABAD}},
                ...
                ES={vendor="Intendente (Marcha sobre Gundabad)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Akrâz-zahar", label="Akrâz-zahar", zone="Eryn Lasgalen"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.TOKEN_OF_KHARUM_UBNAR}},
                ...
                ES={vendor="Vorthur Alientohumo (Kharum-ubnâr)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Azanulbizar", label="Azanulbizar", detail="Amdân", zone="Azanulbizar"},
        ...
        acquire={
            {cost={{amount=7, token=LC.token.ZAKAF_BESHEK}},
                ...
                ES={vendor="Intendente (Haban’akkâ de Thráin)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a la Puerta Noble", label="Noble Gate", zone="Gundabad"},
        ...
        acquire={
            {cost={{amount=20, token=LC.token.SILVER_COIN_OF_GUNDABAD}},
                ...
                ES={vendor="Intendente (Recuperadores de la Fortaleza de la Montaña)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Leitstáth", label="Leitstáth", zone="Gundabad"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Carn Dûm", label="Carn Dûm", zone="Angmar"},
        ...
        acquire={
            {cost={{amount=30, token=LC.token.SARSKILLIN}},
                ...
                ES={vendor="Chiver Me Timbers (Señora de las Excavaciones y Carn Dûm)"},
            ...
            {cost={{amount=30, token=LC.token.SARSKILLIN}},
                ...
                ES={vendor="Muirál (Comerciante de Carn Dûm)"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Pelargir", label="Pelargir", zone="King's Gondor"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.MARK_OF_RENEWAL}},
                ...
                ES={vendor="Intendente de Gondor del rey"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guía de Dol Amroth, Gondor del Rey", label="King's Dol Amroth", zlabel="Dol Amroth", zone="King's Gondor"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Lond Cirion", label="Lond Cirion", zone="Anfalas"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Halrax", label="Halrax", zone="Shield Isles"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Jax Phanâl", label="Jax Phanâl", zone="Umbar"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Bej Mâgha", label="Bej Mâgha", zone="Umbar"},
        ...
        acquire={
            {cost={{amount=15, token=LC.token.UMBARI_TAM}},
                ...
                ES={vendor="Intendente del Mâkhda Khorbo"},
            ...
            {cost={{amount=15, token=LC.token.UMBARI_TAM}},
                ...
                ES={vendor="Intendente del Templo de Utug-bûr"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Umbar", label="Umbar", detail="Baharbêl", zone="Umbar"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a la Taberna del Águila Sangrienta", label="Bloody Eagle Tavern", zone="Umbar"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.EAGLE_BIT}},
                ...
                ES={vendor="Harthabor (Negociante de lealtad)"},
            ...
            {cost={{amount=10, token=LC.token.EAGLE_BIT}},
                ...
                ES={vendor="Achardis (Negociante de lealtad)"},
            ...
            {cost={{amount=10, token=LC.token.EAGLE_BIT}},
                ...
                ES={vendor="Intendente de la Orden del Águila"},
            ...
            {cost={{amount=10, token=LC.token.LEDGER_KEEPER_MARK}},
                ...
                ES={vendor="Aphamâr (Negociante de lealtad)"},
            ...
            {cost={{amount=10, token=LC.token.LEDGER_KEEPER_MARK}},
                ...
                ES={vendor="Intendente de los guardianes de los libros"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Iridír", label="Iridír", zone="Ikorbân"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.SHAGANI_GHIN}},
                ...
                ES={vendor="Intendente de Ikorbân"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Jirush", label="Jirush", zone="Ikorbân"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Urmâkh", label="Urmâkh", zone="Ikorbân"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Maurûsh", label="Maurûsh", zone="Ikorbân"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Utug-bûr", label="Utug-bûr", zone="Ikorbân"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Dun Shûma", label="Dun Shûma", zone="Ikorbân"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.HAMATI_URGUL}},
                ...
                ES={vendor="Intendenta de los Hamâti", deed="Tales of the Crown of Hamât"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Sul Madásh", label="Sul Madásh", zone="Harad"},
        RU={name="Путь в Сул-Мадаш", label="Sul Madásh", zone="Harad"},
        map={{MapType.HARADWAITH, 810, 470}},
        overlap={"0x70070715"},
        acquire={
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
                EN={vendor="Aralath (Quartermaster)"},
                DE={vendor="Aralath (Quartiermeister)"},
                FR={vendor="Aralath (Intendant)"},
                ES={vendor="Aralath (Intendente)"},
                RU={vendor="Аралат (Интендант)"}},
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
                EN={vendor="Kintai Quartermaster"},
                DE={vendor="Kintai-Quartiermeister"},
                FR={vendor="Intendant des Kintai"},
                ES={vendor="Intendente de los Kintai"},
                RU={vendor="Кинтайский интендант"}}},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Ahâba", label="Ahâba", zone="Harad"},
        RU={name="Путь в Ахабу", label="Ahâba", zone="Harad"},
        map={{MapType.HARADWAITH, 560, 570}},
        overlap={"0x70070710"},
        acquire={
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
                EN={vendor="Lumgâna (Quartermaster)"},
                DE={vendor="Lumgâna (Quartiermeisterin)"},
                FR={vendor="Lumgâna (Intendante)"},
                ES={vendor="Lumgâna (Intendente)"},
                RU={vendor="Лумгана (Интендант)"}},
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
                EN={vendor="Hamâti Quartermaster"},
                DE={vendor="Hamâti-Quartiermeisterin"},
                FR={vendor="Intendante des Hamâti"},
                ES={vendor="Intendenta de los Hamâti"},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Zajâna", label="Zajâna", zone="Harad"},
        RU={name="Путь в Заджану", label="Zajâna", zone="Harad"},
        map={{MapType.HARADWAITH, 680, 580}},
        overlap={"0x70070702"},
        acquire={
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
                EN={vendor="Alahamâr (Quartermaster)"},
                DE={vendor="Alahamâr (Quartiermeister)"},
                FR={vendor="Alahamâr (Intendant)"},
                ES={vendor="Alahamâr (Intendente)"},
                RU={vendor="Алахамар (Интендант)"}},
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
                EN={vendor="Zajâna Quartermaster"},
                DE={vendor="Quartiermeister von Zajâna"},
                FR={vendor="Intendant de Zajâna"},
                ES={vendor="Intendente de Zajâna"},
                RU={vendor="Заджанский интендант"}}},
    ...
    self.hunter:AddSkill({
        ...
        ES={name="Guiar a Jiret-menêsh", label="Jiret-menêsh", zone="Harad"},
        RU={name="Путь в Джирет-Менеш", label="Jiret-menêsh", zone="Harad"},
        map={{MapType.HARADWAITH, 630, 530}},
        overlap={"0x700706F7"},
        acquire={
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
                EN={vendor="Semanísi (Quartermaster)"},
                DE={vendor="Semanísi (Quartiermeister)"},
                FR={vendor="Semanisi (Intendant)"},
                ES={vendor="Semanísi (Intendente)"},
                RU={vendor="Семаниси (Интендант)"}},
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
                EN={vendor="Temámir Quartermaster"},
                DE={vendor="Temámir-Quartiermeister"},
                FR={vendor="Intendant des Temamir"},
                ES={vendor="Intendente de los Temámir"},
                RU={vendor="Темамирский интендант"}}},
        rep=LC.rep.TEMAMIR_OF_JIRET_MENESH, repLevel=LC.repLevel.NEUTRAL,
        minLevel=150,
        level=150.73
    })
    -- add the warden skills
    self.warden:AddLabelTag({EN="Muster", DE="Appell", FR="Rassemblement", ES="Reunión", RU="Сбор"})
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Clegur", label="Clegur", zone="Swanfleet"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en la Ciénaga de los Cisnes", label="Swanfleet", detail="Lhan Garan", zone="Swanfleet"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Cardolan", label="Cardolan", detail="Herne", zone="Cardolan"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Andrath", label="Andrath", zone="Cardolan"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Nobotella", label="Nobottle", zone="Yondershire"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Ost Guruth", label="Ost Guruth", zone="Lone-lands"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Esteldín", label="Esteldín", zone="North Downs"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Evendim", label="Evendim", detail="Tinnudir", zone="Evendim"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Tornhad", label="Tornhad", zone="Angle of Mitheithel"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Rivendel", label="Rivendell", zone="Trollshaws"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en las Montañas Nubladas", label="Misty Mountains", detail="Hrimbarg", zone="Misty Mountains"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Puente de Caballetes", label="Trestlebridge", zone="North Downs"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Embarcadero de los Comerciantes", label="Trader's Wharf", zone="Evendim"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Sûri-kylä", label="Sûri-kylä", zone="Forochel"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en la Sala Vigesimoprimera", label="Twenty-first Hall", zone="Moria"},
        ...
        acquire={
            ...
            {cost={{amount=70, token=LC.token.MITHRIL_COIN}},
                ...
                ES={vendor="Entrenador de Vigilantes"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Caras Galadhon", label="Caras Galadhon", zone="Lothlórien"},
        ...
        acquire={
            {cost={{amount=20, token=LC.token.LOTHLORIEN_SILVER_BRANCH}},
                ...
                ES={vendor="Beriawen (Entrenadora de Vigilantes)"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en los lindes del Bosque Negro", label="Mirk-Eaves", zone="Mirkwood"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Harndirion", label="Harndirion", zone="Enedwaith"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Galtrev", label="Galtrev", zone="Dunland"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Stangard", label="Stangard", zone="Great River"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Río Nevado", label="Snowbourn", zone="East Rohan"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Forlaw", label="Forlaw", zone="Wildermore"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Aldburg", label="Aldburg", zone="West Rohan"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en el Abismo de Helm", label="Helm's Deep", zone="West Rohan"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Dol Amroth", label="Dol Amroth", zone="Western Gondor"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Arnach", label="Arnach", zone="Eastern Gondor"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Minas Tirith", label="Minas Tirith", zone="Old Anórien"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en el campamento de guerra", label="War-stead", zone="Far Anórien"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Minas Tirith después de la batalla", label="Minas Tirith after battle", zone="Anórien"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en el Campamento de la Hueste", label="Camp of the Host", zone="The Wastes"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Haerondir", label="Haerondir", zone="The Wastes"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en la base de Udûn", label="Udûn Foothold", zone="Mordor"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Valle", label="Dale", zone="Eryn Lasgalen"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Járnfast", label="Járnfast", zone="The Ironfold"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Skarháld", label="Skarháld", zone="Ered Mithrin"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Beorninghús", label="Beorninghús", zone="Vales of Anduin"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Hultvís", label="Hultvís", zone="Vales of Anduin"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Estolad Lân", label="Estolad Lân", zone="Imlad Morgul"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Limlók", label="Limlók", zone="Wells of Langflood"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Annâk-khurfu", label="Annâk-khurfu", zone="Elderslade"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Akrâz-zahar", label="Akrâz-zahar", zone="Eryn Lasgalen"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Azanulbizar", label="Azanulbizar", detail="Amdân", zone="Azanulbizar"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en la Puerta Noble", label="Noble Gate", zone="Gundabad"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Leitstáth", label="Leitstáth", zone="Gundabad"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Carn Dûm", label="Carn Dûm", zone="Angmar"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Pelargir", label="Pelargir", zone="King's Gondor"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Dol Amroth, Gondor del Rey", label="King's Dol Amroth", zlabel="Dol Amroth", zone="King's Gondor"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Lond Cirion", label="Lond Cirion", zone="Anfalas"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Halrax", label="Halrax", zone="Shield Isles"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Jax Phanâl", label="Jax Phanâl", zone="Umbar"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Acantonarse en Bej Mâgha", label="Bej Mâgha", zone="Umbar"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Umbar", label="Umbar", detail="Baharbêl", zone="Umbar"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en la Taberna del Águila Sangrienta", label="Bloody Eagle Tavern", zone="Umbar"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Iridír", label="Iridír", zone="Ikorbân"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Jirush", label="Jirush", zone="Ikorbân"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Urmâkh", label="Urmâkh", zone="Ikorbân"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Maurûsh", label="Maurûsh", zone="Ikorbân"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Utug-bûr", label="Utug-bûr", zone="Ikorbân"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Dun Shûma", label="Dun Shûma", zone="Ikorbân"},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Jiret-menêsh", label="Jiret-menêsh", zone="Harad"},
        RU={name="Сбор в Джирет-Менеше", label="Jiret-menêsh", zone="Harad"},
        map={{MapType.HARADWAITH, 630, 530}},
        overlap={"0x700706F7"},
        acquire={
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Ahâba", label="Ahâba", zone="Harad"},
        RU={name="Сбор в Ахабе", label="Ahâba", zone="Harad"},
        map={{MapType.HARADWAITH, 560, 570}},
        overlap={"0x70070710"},
        acquire={
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Sul Madásh", label="Sul Madásh", zone="Harad"},
        RU={name="Сбор в Сул-Мадаше", label="Sul Madásh", zone="Harad"},
        map={{MapType.HARADWAITH, 810, 470}},
        overlap={"0x70070715"},
        acquire={
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
    ...
    self.warden:AddSkill({
        ...
        ES={name="Reunión en Zajâna", label="Zajâna", zone="Harad"},
        RU={name="Сбор в Заджане", label="Zajâna", zone="Harad"},
        map={{MapType.HARADWAITH, 680, 580}},
        overlap={"0x70070702"},
        acquire={
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
    ...
    self.mariner:AddLabelTag({EN="Sail", DE="Segeln", FR="Naviguer", ES="Navegar", RU="Плаванье"})
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Celondim", label="Celondim", zone="Ered Luin"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Los Gamos", label="Buckland", zone="Bree"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Tharbad", label="Tharbad", zone="Swanfleet"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Tinnudir", label="Tinnudir", zone="Evendim"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a embarcadero de los comerciantes", label="Trader's Wharf", zone="Evendim"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Sûri-kylä", label="Sûri-kylä", zone="Forochel"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Lothlórien", label="Lothlórien", detail="Egladil", zone="Lothlórien"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a los lindes del Bosque Negro", label="Mirk-eaves", zone="Mirkwood"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a las Tierras Pardas", label="Brown Lands", zone="Great River"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Río Nevado", label="Snowbourn", zone="East Rohan"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Dol Amroth", label="Dol Amroth", zone="Western Gondor"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Ciudad del Lago", label="Lake-town", zone="Eryn Lasgalen"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Pelargir", label="Pelargir", zone="King's Gondor"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Dol Amroth, Gondor del Rey", label="King's Dol Amroth", zlabel="Dol Amroth", zone="King's Gondor"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Lond Cirion", label="Lond Cirion", zone="Anfalas"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Halrax", label="Halrax", zone="Shield Isles"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Jax Phanâl", label="Jax Phanâl", zone="Umbar"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Bej Mâgha", label="Bej Mâgha", zone="Umbar"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Umbar", label="Umbar", detail="Baharbêl", zone="Umbar"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Iridír", label="Iridír", zone="Ikorbân"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Urmâkh", label="Urmâkh", zone="Ikorbân"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Maurûsh", label="Maurûsh", zone="Ikorbân"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Utug-bûr", label="Utug-bûr", zone="Ikorbân"},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Zajâna", label="Zajâna", zone="Harad"},
        RU={name="Отплытие в Заджану", label="Zajâna", zone="Harad"},
        map={{MapType.HARADWAITH, 680, 580}},
        overlap={"0x70070702"},
        acquire={
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Jiret-menêsh", label="Jiret-menêsh", zone="Harad"},
        RU={name="Отплытие в Джирет-Менеш", label="Jiret-menêsh", zone="Harad"},
        map={{MapType.HARADWAITH, 630, 530}},
        overlap={"0x700706F7"},
        acquire={
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
    ...
    self.mariner:AddSkill({
        ...
        ES={name="Navegar a Sul Madásh", label="Sul Madásh", zone="Harad"},
        RU={name="Отплытие в Сул-Мадаш", label="Sul Madásh", zone="Harad"},
        map={{MapType.HARADWAITH, 810, 470}},
        overlap={"0x70070715"},
        acquire={
            {cost={{amount=10, token=LC.token.MUR_GHALA_SARZ}},
    ...
    self.racials:AddLabelTag({EN="Racial", DE="Rasse", FR="Race", ES="Raza", RU="Расовые"})
    self.racials:AddSkill({
        ...
        ES={name="Volver a Bree", desc=[[Esto te permite volver rápidamente a Bree. Esta habilidad puede interrumpirse con facilidad.]], label="Bree", zlabel="West Gate", zone="Bree"},
        ...
        acquire={
            {
                ...
                ES={deed="Enemigo / Enemiga de los Huargos II"},
    ...
    self.racials:AddSkill({
        ...
        ES={name="Volver a la Comarca", label="Michel Delving", zone="Shire"},
        ...
        acquire={
            {
                ...
                ES={deed="Enemigo / Enemiga de las arañas II"},
    ...
    self.racials:AddSkill({
        ...
        ES={name="Volver a la Puerta de Thorin", desc=[[Esto te permite volver rápidamente a la Puerta de Thorin. Esta habilidad se puede interrumpir fácilmente.]], label="Thorin's Gate", zone="Ered Luin"},
        ...
        acquire={
            {
                ...
                ES={deed="Enemigo / Enemiga de los Trasgos II"},
    ...
    self.racials:AddSkill({
        ...
        ES={name="Volver a Rivendel", desc=[[Esto te permite volver rápidamente a Rivendel. Esta habilidad se puede interrumpir fácilmente.]], label="Rivendell", zone="Trollshaws"},
        ...
        acquire={
            {
                ...
                ES={deed="Enemigo / Enemiga de los Orcos II"},
    ...
    self.racials:AddSkill({
        ...
        ES={name="Volver al hogar", desc=[[Vuelve a casa a la Logia de Grimbeorn.]], label="Beorning Home", zone="Vales of Anduin"},
    ...
    self.racials:AddSkill({
        ...
        ES={name="Viaje a Caras Galadhon en Lothlórien", label="Caras Galadhon", zone="Lothlórien"},
    ...
    self.racials:AddSkill({
        ...
        ES={name="Ir a la Mansión de Thorin", label="Thorin's Hall", zone="Ered Luin"},
        ...
        acquire={
            {
                ...
                ES={deed="Enemigo / Enemiga de los sectarios III"},
    ...
    self.racials:AddSkill({
        ...
        ES={name="Volver a Lyndelby", label="Lyndelby", zone="Wells of Langflood"},
        ...
        acquire={
            {
                ...
                ES={deed="De vuelta a la tierra conocida"},
    ...
    self.gen:AddSkill({
        ...
        ES={name="Volver al hogar", desc=[[Volver al hito vinculado:]]},
        ...
        acquire={
            {
                ...
                ES={quest="Preparativos para el Viaje"},
    ...
    self.gen:AddSkill({
        ...
        acquire={
            {cost={{amount=35, token=LC.token.MITHRIL_COIN}},
                ...
                ES={vendor="Comerciante de mithril"},
    ...
    self.gen:AddSkill({
        ...
        ES={name="Ir a la casa personal", desc=[[Vuelve rápidamente a tu casa personal. Esta habilidad se interrumpe fácilmente.]], label="Personal House"},
        ...
        acquire={
            {
                ...
                ES={desc="Buy a House and earn the Novice trait"},
        ...
        acquire={
            {
                ...
                ES={desc="Buy a Premium House and earn the Novice trait"},
    ...
    self.gen:AddSkill({
        ...
        ES={name="Ir a la casa de hermandad", label="Kinship House"},
        ...
        acquire={
            {
                ...
                ES={desc="Become a member of a kinship that has a kinship house"},
    ...
    self.gen:AddSkill({
        ...
        ES={name="Ir a la casa del Miembro de la Hermandad", label="Kinship Member's House"},
        ...
        acquire={
            {
                ...
                ES={desc="Become a member of a kinship"},
                RU={desc="Станьте членом содружества"}}},
        level=1
    })
    -- add the rep skills
    self.rep:AddLabelTag({EN="Rep", DE="Ruf", FR="Rep", ES="Rep", RU="Репутация"})
    self.rep:AddSkill({
        id="0x70023262",
        ...
        ES={name="Volver a Cavada Grande", label="Michel Delving", tag="Store", zone="Shire"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a la Puerta de Thorin", desc=[[Gracias a tu amistad con los Enanos de la Mansión de Thorin, puedes volver rápidamente a la Puerta de Thorin. Esta habilidad se interrumpe fácilmente.]], label="Thorin's Gate", zone="Ered Luin"},
        ...
        acquire={
            {cost={{amount=100, token=LC.token.DOURHAND_CREST}},
                ...
                ES={vendor="Tórth (Mansión de Thorin)"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Bree", desc=[[Gracias a tu amistad con los Hombres de Bree, puedes volver rápidamente a Bree. Esta habilidad se interrumpe fácilmente.]], label="Bree", zlabel="West Gate", zone="Bree"},
        ...
        acquire={
            {cost={{amount=100, token=LC.token.BARROW_TREASURE}},
                ...
                ES={vendor="Tad Cortahoja (Hombres de Bree)"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver al Mercado de Lalia", label="Lalia's Market", zone="Bree"},
        ...
        acquire={
            {cost={{amount=3, token=LC.token.MITHRIL_COIN}},
                ...
                ES={vendor="Lalia (Comerciante de mithril)"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Clegur", label="Clegur", zone="Swanfleet"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a la Ciénaga de los Cisnes", label="Swanfleet", detail="Lhan Garan", zone="Swanfleet"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Cardolan", label="Cardolan", detail="Herne", zone="Cardolan"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Andrath", label="Andrath", zone="Cardolan"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Nobotella", label="Nobottle", zone="Yondershire"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Ost Guruth", label="Ost Guruth", zone="Lone-lands"},
        ...
        acquire={
            {
                ...
                ES={deed="Hermano / Hermana de los Eglain"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Tornhad", label="Tornhad", zone="Angle of Mitheithel"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Rivendel", desc=[[Gracias a tu amistad con los Elfos, puedes volver rápidamente a Rivendel. Esta habilidad se interrumpe fácilmente.]], label="Rivendell", tag="Store", zone="Trollshaws"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a los Archivos de Tracería en Rivendel", label="Tracery Archive", zone="Trollshaws"},
        ...
        acquire={
            {
                ...
                ES={desc="Delving Reward Box (any tier)"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Glân Vraig", label="Glân Vraig", tag="Quest", zone="Ettenmoors"},
        ...
        acquire={
            {
                ...
                ES={quest="Tutorial: Outfitted for Battle"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Puente de Caballetes", label="Trestlebridge", zone="North Downs"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Embarcadero de los Comerciantes", label="Trader's Wharf", zone="Evendim"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver al Bosque Negro", label="Mirkwood", detail="Ost Galadh", zone="Mirkwood"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.MALLEDHRIM_GOLD_STAR_EMBLEM}},
                ...
                ES={vendor="Millaesil (Vendedor de recompensas para hermano de los Malledhrim)"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Enedwaith", label="Enedwaith", detail="Lhanuch", zone="Enedwaith"},
        ...
        acquire={
            {cost={{amount=20, token=LC.token.SILVER_TOKEN_OF_WILDS}},
                ...
                ES={vendor="Mabon (Vendedor de recompensas Algraig)"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Galtrev", label="Galtrev", zone="Dunland"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Stangard", label="Stangard", zone="Great River"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Río Nevado", label="Snowbourn", zone="East Rohan"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Forlaw", label="Forlaw", zone="Wildermore"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Aldburg", label="Aldburg", zone="West Rohan"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver al Abismo de Helm", label="Helm's Deep", zone="West Rohan"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver al Valle Emboscado", label="Derndingle", zone="West Rohan"},
        ...
        acquire={
            {cost={{amount=10, token=LC.token.FANGORN_LEAF}},
                ...
                ES={vendor="Ramaviva (Ent de Fangorn)"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Dol Amroth", label="Dol Amroth", zone="Western Gondor"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Arnach", label="Arnach", zone="Eastern Gondor"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Minas Tirith", label="Minas Tirith", zone="Old Anórien"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver al campamento de guerra", label="War-stead", zone="Far Anórien"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Minas Tirith después de la batalla", label="Minas Tirith after-battle", zone="Anórien"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver al Campamento de la Hueste", label="Camp of the Host", zone="The Wastes"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Haerondir", label="Haerondir", zone="The Wastes"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a la base de Udûn", label="Udûn Foothold", zone="Mordor"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Viaje a la Corte de Lothlórien", label="Court of Lothlórien", tag="Quest", zone="Lothlórien"},
        ...
        acquire={
            {
                ...
                ES={allegiance="La Corte de Lothlórien", quest="Chapter 1: A Council Waiting"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Viaje a la Sala del Rey", label="Hall of the King", tag="Quest", zone="Old Anórien"},
        ...
        acquire={
            {
                ...
                ES={allegiance="El Reino de Gondor", quest="Chapter 1: The King and the Steward"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Viaje a la Sala Bajo la Montaña", label="Hall Under the Mountain", tag="Quest", zone="Ered Mithrin"},
        ...
        acquire={
            {
                ...
                ES={allegiance="Pueblo de Durin", quest="Chapter 1: Beneath the Lonely Mountain"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Viaje a Bâr Thorenion", label="Bâr Thorenion", tag="Quest", zone="Ithilien"},
        ...
        acquire={
            {
                ...
                ES={allegiance="Hobbits de la Comunidad", quest="Capítulo 1: Un lugar para los hobbits"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Valle", label="Dale", zone="Eryn Lasgalen"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Járnfast", label="Járnfast", zone="The Ironfold"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Skarháld", label="Skarháld", zone="Ered Mithrin"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Beorninghús", label="Beorninghús", zone="Vales of Anduin"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Hultvís", label="Hultvís", zone="Vales of Anduin"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Estolad Lân", label="Estolad Lân", zone="Imlad Morgul"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Limlók", label="Limlók", zone="Wells of Langflood"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Annâk-khurfu", label="Annâk-khurfu", zone="Elderslade"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Akrâz-zahar", label="Akrâz-zahar", zone="Eryn Lasgalen"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Azanulbizar", label="Azanulbizar", detail="Amdân", zone="Azanulbizar"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a la Puerta Noble", label="Noble Gate", zone="Gundabad"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Leitstáth", label="Leitstáth", zone="Gundabad"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Viajar a la Sala de Vérnozal", label="Vérnozal", tag="Quest", zone="Gundabad"},
        ...
        acquire={
            {
                ...
                ES={allegiance="El clan Zhélruka", quest="Chapter 1: The Rightful Claim"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Carn Dûm", label="Carn Dûm", zone="Angmar"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Pelargir", label="Pelargir", zone="King's Gondor"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Dol Amroth, Gondor del Rey", label="King's Dol Amroth", zlabel="Dol Amroth", zone="King's Gondor"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Lond Cirion", label="Lond Cirion", zone="Anfalas"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Halrax", label="Halrax", zone="Shield Isles"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Jax Phanâl", label="Jax Phanâl", zone="Umbar"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Bej Mâgha", label="Bej Mâgha", zone="Umbar"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Umbar", label="Umbar", detail="Baharbêl", zone="Umbar"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a la Taberna del Águila Sangrienta", label="Bloody Eagle Tavern", zone="Umbar"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Viajar a los Guardianes del Libro Mayor", label="Ledger-Keepers", tag="Quest", zone="Umbar"},
        ...
        acquire={
            {rank=10,
                ...
                ES={allegiance="Guardianes del libro mayor", deed="Guardianes de los libros de Umbar Baharbêl: Nivel de Lealtad 10"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Viajar a la Orden del Águila", label="Order of the Eagle", tag="Quest", zone="Umbar"},
        ...
        acquire={
            {rank=10,
                ...
                ES={allegiance="Orden del Águila", deed="Orden del Águila: Nivel de Lealtad 10"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Iridír", label="Iridír", zone="Ikorbân"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Jirush", label="Jirush", zone="Ikorbân"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Urmâkh", label="Urmâkh", zone="Ikorbân"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Maurûsh", label="Maurûsh", zone="Ikorbân"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Utug-bûr", label="Utug-bûr", zone="Ikorbân"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Dun Shûma", label="Dun Shûma", zone="Ikorbân"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Ahâba", label="Ahâba", zone="Harad"},
        RU={name="Возвращение в Ахабу", label="Ahâba", zone="Harad"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Zajâna", label="Zajâna", zone="Harad"},
        RU={name="Возвращение в Заджану", label="Zajâna", zone="Harad"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Jiret-menêsh", label="Jiret-menêsh", zone="Harad"},
        RU={name="Возвращение в Джирет-Менеш", label="Jiret-menêsh", zone="Harad"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a Sul Madásh", label="Sul Madásh", zone="Harad"},
        RU={name="Возвращение Сул-Мадаш", label="Sul Madásh", zone="Harad"},
...
function TravelDictionary:CreateCreepDictionary()
    ...
    self.creep:AddSkill({
        ...
        ES={name="Mapa para ir al Pie de Gram"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Mapa rudimentario para ir a Isendeep"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Mapa tosco para ir a Tol Ascarnen"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Mapa tosco para ir a Lugazag"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Mapa tosco para ir a Tirith Rhaw"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Mapa tosco para ir al Bosque Funesto"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Mapa pobre para ir a Isendeep"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Mapa pobre para ir a Tol Ascarnen"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Mapa pobre para ir a Lugazag"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Mapa pobre para ir a Tirith Rhaw"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Mapa pobre para ir al Bosque Funesto"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Buen mapa para ir a Isendeep"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Buen mapa para ir a Tol Ascarnen"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Buen mapa para ir a Lugazag"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Buen mapa para ir a Tirith Rhaw"},
    ...
    self.creep:AddSkill({
        ...
        ES={name="Buen mapa para ir al Bosque Funesto"},

...
function TravelDictionary:CreateDictionaries()
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=10, token=LC.token.COPPER_BOUNDERS_COIN}},
                ...
                ES={vendor="Intendente (Yonder-watch)"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=15, token=LC.token.MARK_OF_ANGLE}},
                ...
                ES={vendor="Intendente (Defenders of the Angle)"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=176, token=LC.token.SILVER}},
                ...
                ES={vendor="Dunlending Quartermaster"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=5, token=LC.token.SILVER_TOKEN_OF_ANDUIN}},
                ...
                ES={vendor="Ordlaf (Stangard Rewards Vendor)"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=50, token=LC.token.SILVER_TOKEN_OF_RIDDERMARK}},
                ...
                ES={vendor="Eastemnet Miscellany Quartermaster"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=10, token=LC.token.SILVER_SIGNET_OF_THANDRIM}},
                ...
                ES={vendor="Intendente (Conquest of Gorgoroth Rewards)"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            ...
            {cost={{amount=10, token=LC.token.TOKEN_OF_LAKE_AND_RIVERS}},
                ...
                ES={vendor="Intendente (Elves of Felegoth Rewards)"},
            ...
            {cost={{amount=10, token=LC.token.TOKEN_OF_LAKE_AND_RIVERS}},
                ...
                ES={vendor="Intendente (Dwarves of Erebor Rewards)"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=5, token=LC.token.MARK_OF_LONGBEARDS}},
                ...
                ES={vendor="Intendente (Dwarf-holds Rewards)"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=20, token=LC.token.VALES_BEORNING_TOKEN}},
                ...
                ES={vendor="Protector of the Vales"},
            ...
            {cost={{amount=20, token=LC.token.VALES_BEORNING_TOKEN}},
                ...
                ES={vendor="Intendente (Wilderfolk Rewards)"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=7, token=LC.token.ZAKAF_BESHEK}},
                ...
                ES={vendor="Intendente (Haban’akkâ of Thráin)"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=30, token=LC.token.SARSKILLIN}},
                ...
                ES={vendor="Chiver Me Timbers (Lady of Delvings and Carn Dûm)"},
            ...
            {cost={{amount=30, token=LC.token.SARSKILLIN}},
                ...
                ES={vendor="Muirál (Trader of Carn Dûm)"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=10, token=LC.token.MARK_OF_RENEWAL}},
                ...
                ES={vendor="King's Gondor Quartermaster"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=15, token=LC.token.UMBARI_TAM}},
                ...
                ES={vendor="Mâkhda Khorbo Quartermaster"},
            ...
            {cost={{amount=15, token=LC.token.UMBARI_TAM}},
                ...
                ES={vendor="Temple of Utug-bûr Quartermaster"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=10, token=LC.token.EAGLE_BIT}},
                ...
                ES={vendor="Harthabor (Allegiance Barterer)"},
            ...
            {cost={{amount=10, token=LC.token.EAGLE_BIT}},
                ...
                ES={vendor="Achardis (Allegiance Barterer)"},
            ...
            {cost={{amount=10, token=LC.token.EAGLE_BIT}},
                ...
                ES={vendor="Order of the Eagle Quartermaster"},
            ...
            {cost={{amount=10, token=LC.token.LEDGER_KEEPER_MARK}},
                ...
                ES={vendor="Ledger-keepers Quartermaster"},
    ...
    self.hunter:AddSkill({
        ...
        acquire={
            {cost={{amount=10, token=LC.token.SHAGANI_GHIN}},
                ...
                ES={vendor="Ikorbâni Quartermaster"},
        ...
        acquire={
            {
                ...
                ES={deed="Enemistad de los Huargos II"},
        ...
        acquire={
            {
                ...
                ES={deed="Enemistad de las arañas II"},
        ...
        acquire={
            {
                ...
                ES={deed="Enemistad de los Trasgos II"},
        ...
        acquire={
            {
                ...
                ES={deed="Enemistad de los Orcos II"},
        ...
        acquire={
            {
                ...
                ES={deed="Enmity of the Cultists III"},
    ...
    self.rep:AddSkill({
        ...
        ES={name="Volver a El Valle Emboscado", label="Derndingle", zone="West Rohan"},
        ...
        acquire={
            {
                ...
                ES={allegiance="Hobbits de la Compañía", quest="Capítulo 1: Un lugar para los hobbits"},
    ...
    self.rep:AddSkill({
        ...
        acquire={
            {rank=10,
                ...
                ES={allegiance="Guardianes del libro mayor", deed="Ledger-keepers: Umbar Barharbêl: Allegiance Level 10"},
    ...
    self.rep:AddSkill({
        ...
        acquire={
            {rank=10,
                ...
                ES={allegiance="Orden del Águila", deed="Order of the Eagle: Allegiance Level 10"},

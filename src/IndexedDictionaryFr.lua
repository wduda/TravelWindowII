...
function TravelDictionaries:CreateDictionaries()
    ...
    hunterLocations:AddSkill("Guide vers le Palais de Thorin", "0x70003F41", "Guide vers le Palais de Thorin (Guide)");
    hunterLocations:AddSkill("Guide vers Grand'Cave", "0x7000A2C3", "Guide vers Grand'Cave  (Guide)");
    hunterLocations:AddSkill("Guide vers Esteldin", "0x70003F43", "Guide vers Esteldin (Guide)");
    hunterLocations:AddSkill("Guide vers Evendim", "0x7000A2C4", "Guide vers Evendim (Guide)");
    hunterLocations:AddSkill("Guide vers Ost Guruth", "0x7000A2C2", "Guide vers Ost Guruth (Guide)");
    hunterLocations:AddSkill("Guide vers Fondcombe", "0x70003F44", "Guide vers Fondcombe (Guide)");
    hunterLocations:AddSkill("Guide vers Sûri-Kylä", "0x70017C82", "Guide vers Sûri-kylä (Guide)");
    hunterLocations:AddSkill("Guide vers l'ouest d'Angmar", "0x7000A2C5", "Guide vers l'ouest d'Angmar (Guide)");
    hunterLocations:AddSkill("Guide vers l'est d'Angmar", "0x7000A2C6", "Guide vers l'est d'Angmar (Guide)");
    hunterLocations:AddSkill("Guide vers Echad Dunann", "0x70017C81", "Guide vers Echad Dunann (Guide)");
    hunterLocations:AddSkill("Guide vers la vingt et unième salle", "0x70017C7A", "Guide vers la vingt et unième salle (Guide)");
    hunterLocations:AddSkill("Guide vers l'Orée noire", "0x7001F459", "Guide vers l'Orée noire (Guide)");
    hunterLocations:AddSkill("Guide vers Harndirion", "0x700235EF", "Guide vers Harndirion (Guide)");
    hunterLocations:AddSkill("Guide pour Galtrev", "0x7002A93F", "Guide pour Galtrev (Guide)");
    hunterLocations:AddSkill("Guide vers Stangarde", "0x7002C62C", "Guide vers Stangarde (Guide)");
    hunterLocations:AddSkill("Guide vers Caras Galadhon", "0x7002E754", "Guide vers Caras Galadhon (Guide)");
    hunterLocations:AddSkill("Guide vers les Monts Brumeux", "0x7002E756", "Guide vers les Monts Brumeux (Guide)");
    hunterLocations:AddSkill("Guide vers Neigebronne", "0x7003198E", "Guide vers Neigebronne (Guide)");
    hunterLocations:AddSkill("Guide vers Forloi", "0x70036B5D", "Guide vers Forloi (Guide)");
    hunterLocations:AddSkill("Guide vers Aldburg", "0x7003DC71", "Guide vers Aldburg (Guide)");
    hunterLocations:AddSkill("Guide vers le Gouffre de Helm", "0x7003DC72", "Guide vers le Gouffre de Helm (Guide)");
    hunterLocations:AddSkill("Guide vers Dol Amroth", "0x70041197", "Guide vers Dol Amroth (Guide)");
    hunterLocations:AddSkill("Guide vers Arnach", "0x70043A63", "Guide pour Arnach (Guide)");
    hunterLocations:AddSkill("Guide vers Minas Tirith", "0x70044985", "Guide vers Minas Tirith (Guide)");
    hunterLocations:AddSkill("Guide pour se rendre au Camp Militaire", "0x700459AF", "Guide pour se rendre au Camp Militaire (Guide)");
    hunterLocations:AddSkill("Guide de Minas Tirith après la bataille", "0x70046CBB", "Guide de Minas Tirith après la bataille (Guide)");
    hunterLocations:AddSkill("Guide vers Henneth Annûn", "0x70047077", "Guide vers Henneth Annûn (Guide)");
    hunterLocations:AddSkill("Guide vers Osgiliath après la bataille", "0x70047074", "Guide vers Osgiliath après la bataille (Guide)");
    hunterLocations:AddSkill("Guide vers le Camp de l'armée", "0x70047BFA", "Guide to the Camp of the Host (Guide)");
    hunterLocations:AddSkill("Guide vers Haerondir", "0x70047C1D", "Guide vers Haerondir (Guide)");
    hunterLocations:AddSkill("Guide vers le fort d'Udûn", "0x7004AE1E", "Guide vers le fort d'Udûn (Guide)");
    hunterLocations:AddSkill("Guide vers Jarnfast", "0x7004facc", "Guide vers Jarnfast (Guide)");
    hunterLocations:AddSkill("Guide vers Skarhald", "0x7004facb", "Guide vers Skarhald (Guide)");
    hunterLocations:AddSkill("Guide vers Dale", "0x7004d73b", "Guide vers Dale (Guide)");
    hunterLocations:AddSkill("Guide vers Beorninghus", "0x70052F07", "Guide pour Beorninghus (Guide)");
    hunterLocations:AddSkill("Guide vers Hultvis", "0x70052F08", "Guide vers Hultvis (Guide)");
    hunterLocations:AddSkill("Guide vers Estolad Lân", "0x700551F4", "Guide vers Estolad Lân (Guide)");
    hunterLocations:AddSkill("Guide vers Limlok", "0x7005762d", "Guide de Limlok (Guide)");
    hunterLocations:AddSkill("Guide vers Annâk-khurfu", "0x7005856F", "Guide de Annâk-khurfu (Guide)");

	wardenLocations:AddSkill("Rassemblement à Ost Guruth", "0x70014786", "Rassemblement à Ost Guruth (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Esteldin", "0x70014798", "Rassemblement à Esteldin (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Evendim", "0x7001478E", "Rassemblement dans la région d'Evendim (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Fondcombe", "0x70014791", "Rassemblement à Fondcombe (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Sûri-Kylä", "0x700237D4", "Rassemblement à Sûri-kylä (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à la vingt et unième salle", "0x7001819E", "Rassemblement à la vingt et unième salle (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à l'Orée noire", "0x7001F45C", "Rassemblement à l'Orée noire (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Harndirion", "0x700235EB", "Rassemblement à Harndirion (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Galtrev", "0x7002A90A", "Rassemblement à Galtrev (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Stangarde", "0x7002C646", "Rassemblement à Stangarde (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Caras Galadhon", "0x700303DF", "Rassemblement à Caras Galadhon (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement dans les monts brumeux", "0x700303DD", "Rassemblement dans les monts brumeux (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Neigebronne", "0x7003198D", "Rassemblement à Neigebronne (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Forloi", "0x70036B5B", "Rassemblement à Forloi (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Aldburg", "0x7003DC7A", "Rassemblement à Aldburg (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement au Gouffre de Helm", "0x7003DC79", "Rassemblement au Gouffre de Helm (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement au Dol Amroth", "0x70041198", "Rassemblement au Dol Amroth (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement au Arnach", "0x70043A66", "Rassemblement au Arnach (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement au Minas Tirith", "0x70044982", "Rassemblement au Minas Tirith (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement au Camp Militaire", "0x700459AA", "Rassemblement au Camp Militaire (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Minas Tirith après la bataille", "0x70046CBF", "Rassemblement à Minas Tirith après la bataille (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Henneth Annûn", "0x70047075", "Rassemblement à Henneth Annûn (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Osgiliath après la bataille", "0x70047076", "Rassemblement à Osgiliath après la bataille (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement au Camp de l'armée", "0x70047BFC", "Rassemblement au Camp de l'armée (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Haerondir", "0x70047C23", "Rassemblement à Haerondir (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement dans le fort d'Udûn", "0x7004AE1F", "Rassemblement dans le fort d'Udûn (Rassemblement)");
    wardenLocations:AddSkill("Retour à Jarnfast", "0x7004FACA", "Retour à Jarnfast (Rassemblement)");
    wardenLocations:AddSkill("Retour à Skarhald", "0x7004FACD", "Retour à Skarhald (Rassemblement)");
    wardenLocations:AddSkill("Retour à Dale", "0x7004d73a", "Retour à Dale (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Beorninghus", "0x70052F07", "Rassemblement à Beorninghus (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Hultvis", "0x70052F08", "Rassemblement à Hultvis (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Estolad Lân", "0x700551F2", "Rassemblement à Estolad Lân (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Limlok", "0x70057635", "Rassemblement à Limlok (Rassemblement)");
    wardenLocations:AddSkill("Rassemblement à Annâk-khurfu", "0x7005856F", "Rassemblement à Annâk-khurfu (Rassemblement)");
    ...
    genLocations:AddSkill("Retour à la maison personnelle", "0x7000D046", "Retour à la maison personnelle");
    genLocations:AddSkill("Allez à une maison premium", "0x70046EE4", "Allez à une maison premium");
    genLocations:AddSkill("Retour à la maison de confrérie", "0x7000D047", "Retour à la maison de confrérie");
    genLocations:AddSkill("Retour à la maison d'un membre de confrérie", "0x70057C36", "Retour à la maison d'un membre de confrérie");

    repLocations:AddSkill("Retour : Porte de Thorin", "0x7001BF91", "Retour : Porte de Thorin (Rep/Shop)");
